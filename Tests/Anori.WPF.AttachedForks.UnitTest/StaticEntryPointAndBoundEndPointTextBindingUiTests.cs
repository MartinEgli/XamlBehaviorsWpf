// -----------------------------------------------------------------------
// <copyright file="StaticEntryPointAndBoundEndPointTextBindingUiTests.cs" company="Anori Soft"
...
namespace Anori.WPF.AttachedAncestorProperties.UnitTest
{
    ...
    [TestClass]
    public class StaticEntryPointAndBoundEndPointTextBindingUiTests : UiTestSessionBase
    {
        /// <summary>
        ///     Classes the cleanup.
        /// </summary>
        ...
        {
            var endpoint = Session.FindElementByAccessibilityId("EndPoint1");
