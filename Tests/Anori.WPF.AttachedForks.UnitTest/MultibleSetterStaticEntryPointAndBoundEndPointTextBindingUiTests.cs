// -----------------------------------------------------------------------
// <copyright file="MultibleSetterStaticEntryPointAndBoundEndPointTextBindingUiTests.cs" company="Anori Soft"
...
namespace Anori.WPF.AttachedAncestorProperties.UnitTest
{
    ...
    [TestClass]
    public class MultibleSetterStaticEntryPointAndBoundEndPointTextBindingUiTests : UiTestSessionBase
    {
        /// <summary>
        ///     Classes the cleanup.
        /// </summary>
        ...
        /// </summary>
        [TestInitialize]
        public void TestInitialize() => SetContent(() => new StaticEntryPointAndBoundEndPointTextView2());
    }
}
