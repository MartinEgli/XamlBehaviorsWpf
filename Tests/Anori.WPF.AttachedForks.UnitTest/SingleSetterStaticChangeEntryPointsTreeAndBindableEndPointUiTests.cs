// -----------------------------------------------------------------------
// <copyright file="SingleSetterStaticChangeEntryPointsTreeAndBindableEndPointUiTests.cs" company="Anori Soft"
...
namespace Anori.WPF.AttachedAncestorProperties.UnitTest
{
    ...
    using Anori.WPF.AttachedAncestorProperties.GuiTest.SingleSetter.Static;
    using Anori.WPF.Testing;

    using Microsoft.VisualStudio.TestTools.UnitTesting;

    [TestClass]
    public class SingleSetterStaticChangeEntryPointsTreeAndBindableEndPointUiTests : UiTestSessionBase
    {
        /// <summary>
        ///     The addpanel
        /// </summary>
        ...
        /// </summary>
        [TestInitialize]
        public void TestInitialize() => SetContent(() => new StaticChangeEntryPointsTreeAndBindableEndPointView());
    }
}
