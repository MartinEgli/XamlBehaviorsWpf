...
namespace Anori.WPF.AttachedAncestorProperties.UnitTest
{
    ...
    using StaticEntryPointAndUpdateableEndPointTextView = Anori.WPF.AttachedAncestorProperties.GuiTest.SingleSetter.Static.StaticEntryPointAndUpdateableEndPointTextView;
