...
namespace Anori.WPF.AttachedAncestorProperties.UnitTest
{
    ...
    [TestClass]
    public class MultiSetterBoundEntryPointAndBoundEndPointTextControlUiTests : UiTestSessionBase
    {
        /// <summary>
        ///     The end point
        /// </summary>
        ...
        /// </summary>
        [TestInitialize]
        public void TestInitialize() => SetContent(() => new BoundEntryPointAndBoundEndPointTextControlView2());
    }
}
