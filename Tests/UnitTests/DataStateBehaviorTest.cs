// -----------------------------------------------------------------------
// <copyright file="DataStateBehaviorTest.cs" company="Anori Soft">
...
namespace Microsoft.Xaml.Interactions.UnitTests
{
    ...
    public static class VisualStateHelper
    {
        ...
        public static T CreateObjectWithStates<T>()
    ...
    public sealed class DataStateBehaviorTest
    {
        ...
        public void TrueStateChanges_TransitionsToNewTrueState()
        {
            ...
            Assert.AreEqual(
                vsmStub.LastStateName,
                VisualStateHelper.ArbitraryThirdStateName,
        ...
        public void ValueChangesToMatchBinding_TransitionsToTrueState()
        {
            ...
            Assert.AreEqual(
                vsmStub.LastStateName,
                VisualStateHelper.DefaultTrueStateName,
        ...
        public void ValueChangesToNotMatchBinding_TransitionsToFalseState()
        {
            ...
            Assert.AreEqual(
                vsmStub.LastStateName,
                VisualStateHelper.DefaultFalseStateName,
