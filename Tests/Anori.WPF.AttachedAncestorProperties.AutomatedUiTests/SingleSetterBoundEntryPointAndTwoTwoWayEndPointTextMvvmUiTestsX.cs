// -----------------------------------------------------------------------
// <copyright file="SingleSetterBoundEntryPointAndTwoBoundEndPointTextMvvmUiTests.cs" company="Anori Soft"
...
namespace Anori.WPF.AttachedAncestorProperties.AutomatedUiTests
{
    ...
    public class SingleSetterBoundEntryPointAndTwoTwoWayEndPointTextMvvmUiTestsX : UiTestSessionBase
    {
        /// <summary>
        ///     The endpoint1
        /// </summary>
