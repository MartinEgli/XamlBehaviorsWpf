// ----------------------------------------------------------------------- <copyright
// file="StaticMultiEntryPointsAndUpdateableEndPointsBoolControlUiTests.cs" company="Anori Soft"
...
namespace Anori.WPF.AttachedAncestorProperties.AutomatedUiTests
{
    ...
    [TestClass]
    public class StaticMultiEntryPointsAndUpdateableEndPointsBoolControlUiTests : UiTestSessionBase
    {
        ...
        public void TestInitialize() =>
            SetContent(() => new StaticMultiEntryPointsAndUpdateableEndPointsBoolControlView());
    }
}
