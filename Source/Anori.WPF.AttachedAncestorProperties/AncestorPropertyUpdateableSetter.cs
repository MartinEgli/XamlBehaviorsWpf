// -----------------------------------------------------------------------
// <copyright file="AncestorPropertyUpdateableSetter.cs" company="Anori Soft"
...
namespace Anori.WPF.AttachedAncestorProperties
{
    ...
    internal class AncestorPropertyUpdateableSetter : AncestorPropertySetterBase
    {
        ...
        public AncestorPropertyUpdateableSetter(
        ...
        public object ProvideValue([NotNull] IServiceProvider serviceProvider)
        {
            ...
            {
                return AncestorProperty.GetValueOrRegisterParentChanged(
            ...
            object value = AncestorProperty.GetValueOrRegisterParentChanged(
                this.DependencyObject,
                this.SetterProperty,
                this.OnSourceChanged);
        ...
        protected override void UpdateTarget(object sender)
        {
            ...
            {
                this.Update(
                    AncestorProperty.GetValueOrRegisterParentChanged(
                        dependencyObj,
                        this.SetterProperty,
                        this.OnSourceChanged));
            }
