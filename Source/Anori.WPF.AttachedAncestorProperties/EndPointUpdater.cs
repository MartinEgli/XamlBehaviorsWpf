...
namespace Anori.WPF.AttachedAncestorProperties
{
    ...
    internal class EndPointUpdater : INotifyPropertyChanged
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EndPointUpdater"/> class.
        /// </summary>
        /// <param name="ancestor">The owner.</param>
        /// <exception cref="ArgumentNullException">owner</exception>
        public EndPointUpdater([NotNull] DependencyObject ancestor)
        {
