...
namespace Anori.WPF.AttachedAncestorProperties
{
    ...
    public class BindingGetterExtension : UpdateableMarkupExtension
    {
        /// <summary>
        ...
        private object Create([NotNull] IServiceProvider serviceProvider,
            ...
            new AncestorPropertyBindableSetter(dependencyObject, this.UpdateSourceTrigger, SetterProperty, this.Path).ProvideValue(serviceProvider);
    }
}
