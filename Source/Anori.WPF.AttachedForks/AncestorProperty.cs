// ----------------------------------------------------------------------- <copyright
// file="AncestorProperty.cs" company="Anori Soft" Copyright (c) Anori Soft. All rights reserved.
// </copyright> -----------------------------------------------------------------------
...
namespace Anori.WPF.AttachedAncestorProperties
{
    ...
    public class AncestorProperty : AncestorPropertyBase<object>

    {
    }

    public abstract class AncestorPropertyBase<TValue> : DependencyObject
