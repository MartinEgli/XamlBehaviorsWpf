...
Using Behaviors SDK
-------------------
To use behaviors in your project, add the [Anori.WPF.Behaviors.Wpf](https://www.nuget.org/packages/Anori.WPF.Behaviors.Wpf) NuGet package to your project.
...
**Build and Create XAML Behaviors NuGet**
 ...
 - Run msbuild src\Anori.WPF.Behaviors\Anori.WPF.Behaviors.csproj /t:Pack
